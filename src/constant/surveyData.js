export const insuranceSurvey = [
  ...
  },
  {
    ...
    options: ["자동차보험", "실손보험", "건강보험", "종신보험", "연금보험", "기타"],
    nextQuestion: 2,
  },
  {
    id: 2,
...
export const loanSurvey = [
  ...
  },
  {
    ...
    options: ['신용대출', '담보대출', '전월세/반환보증대출', '자동차대출', '주택도시기금대출'],
    nextQuestion: (option) => {
      switch (option) {
        case '신용대출': return 2;
        case '담보대출': return 3;
        case '전월세/반환보증대출': return 4;
        case '자동차대출': return 5;
        case '주택도시기금대출': return 6;
      }
    },
  },
  {
  ...
  },
  {
    id: 6,
    text: '해당되는 유형을 선택해주세요.',
    options: ["무주택", "청년", "중소기업 재직", "신혼", "2년 이내 출산경험", "기타"],
    nextQuestion: null,
  },
];

export const savingSurvey = [
  {
    id: 0,
    text: '나는 저축을 할 때',
    options: ["한 번에 넣어 목돈을 보관하고 싶다.", "조금씩 넣어 목돈을 만들고 싶다."],
    nextQuestion: 1,
  },
  {
    id: 1,
  ...
  },
  {
    id: 2,
    text: '나는 상품에 가입할 때',
    options: ["온라인으로만 가입하고 싶다.", "금리가 괜찮다면 영업점 방문도 상관없다."],
    nextQuestion: 3,
  },
  {
    id: 3,
    text: '상품 가입 기간은',
    options: ["6개월 이하였으면 좋겠다.", "6개월 ~ 1년 정도가 좋다.", "1년 이상도 상관없다."],
    nextQuestion: 4,
  },
  {
    id: 4,
    text: '나의 저축 성향은',
    options: ["조금 번거롭더라도 우대 이율을 챙기는 편이다.", "확정된 이자율만 받아도 된다."],
    nextQuestion: null,
  },
];