  ...
  >
    <swiper-slide>
      <div class="w-screen h-screen relative overflow-hidden">
          ...
          >
            <h1 class="absolute left-1/2 transform -translate-x-1/2 text-center text-white text-xl sm:text-2xl md:text-3xl font-bold px-4 w-full"
                style="top: 25vh;">
        ...
        <div v-if="!isExpanded" class="flex flex-col justify-center items-center absolute bottom-2 left-1/2 transform -translate-x-1/2 text-center text-gray-400 space-y-0">
