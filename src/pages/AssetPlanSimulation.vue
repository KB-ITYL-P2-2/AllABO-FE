...
const getChartData = title => {
  if (title === "총 자산") {
    return {
      ...
      datasets: [
        { ...chartData.value.현재_전략.datasets[0], borderColor: "#D9D9D9", backgroundColor: "#D9D9D9" },
        { ...chartData.value.개선된_전략.datasets[0], borderColor: "#F4BF42", backgroundColor: "#F4BF42" },
      ],
    };
  } else if (title === "총 부채") {
    return {
      labels: chartData.value.현재_전략.labels,
      datasets: [
        { ...chartData.value.현재_전략.datasets[1], borderColor: "#D9D9D9", backgroundColor: "#D9D9D9" },
        { ...chartData.value.개선된_전략.datasets[1], borderColor: "#FF5252", backgroundColor: "#FF5252" },
      ],
    };
  } else if (title === "순 자산") {
    return {
      labels: chartData.value.현재_전략.labels,
      datasets: [
        { ...chartData.value.현재_전략.datasets[2], borderColor: "#D9D9D9", backgroundColor: "#D9D9D9" },
        { ...chartData.value.개선된_전략.datasets[2], borderColor: "#58AEFF", backgroundColor: "#58AEFF" },
      ],
    };
    ...
    return {
      labels: chartData.value.현재_전략.labels,
      datasets: [
        { ...chartData.value.현재_전략.datasets[3], borderColor: "#D9D9D9", backgroundColor: "#D9D9D9" },
        { ...chartData.value.개선된_전략.datasets[3], borderColor: "#B1EF5A", backgroundColor: "#B1EF5A" },
      ],
    };
  }
};
