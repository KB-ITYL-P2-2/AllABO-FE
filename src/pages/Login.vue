  ...
  <div class="h-screen flex flex-col">
    ...
    <div class="h-[60vh] bg-white flex flex-col items-center justify-start">
      <div class="mt-[60px] flex justify-center">
        <form class="w-[400px]">
          ...
          <input 
            ...
            class="pl-4 h-[50px] w-full rounded-[15px] border border-kb-gray-2 focus:outline-none focus:ring-2 focus:ring-kb-brown-2 transition ease-in-out duration-150"
          />
          ...
          <button 
            type="submit"
            class="h-[50px] w-full rounded-[15px] bg-kb-brown-1 text-white text-[16px] mt-[30px] hover:bg-kb-yellow-1 focus:bg-kb-yellow-1 transition ease-in-out duration-150"
          >
            로그인
          </button>
          
          <!-- 추가 옵션 -->
          <div class="mt-4 flex justify-center space-x-8 text-sm text-kb-gray-2">
      ...
      <div class="flex justify-center mt-[60px]">
        <hr class="w-28 mt-3 border-kb-gray-2"/> 
        <p class="px-10 text-kb-gray-2 text-sm">간편 로그인</p>
        <hr class="w-28 mt-3 border-kb-gray-2"/> 
      </div>

      <!-- 간편 로그인 버튼 -->
      <div class="flex justify-center mt-[30px] space-x-4">
        <button class="w-[55px] h-[55px] rounded-full bg-[#FEE500] flex items-center justify-center hover:shadow-md transition ease-in-out duration-150">
          <img src="../assets/images/kakaoBtn.png" alt="카카오 로그인" class="w-6 h-6">
        </button>
        <button class="w-[55px] h-[55px] rounded-full border-[1px] border-gray-200 flex items-center justify-center hover:shadow-md transition ease-in-out duration-150">
