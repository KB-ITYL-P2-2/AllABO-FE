<template>
    ...
    <div class="flex">
        <SideBar/>
<div>
    <p class="text-[20px] text-font-color  ml-[150px] mb-[40px]">회원 탈퇴 </p>
    <div class="mb-[100px]justify-center ml-[150px]">
    ...
    <div class="flex justify-center ml-[150px] mt-[50px] w-[950px] h-[250px] rounded-[15px] border-2 ">
      ...
      <p class="text-lg text-kb-gray-2  ml-[150px] mt-[40px]">유의 사항 </p>
      <div class="flex ml-[150px] mt-[10px] w-[950px] h-[100px] rounded-[15px] border-2 ">
        <p class=" px-8 text-font-color text-[16px]">
            <br>
            회원 탈퇴 처리 후에는 회원님의 개인정보를 복원할 수없으며, 회원탈퇴 진행 시 해당 이메일은 영구적으로 삭제되어 재가입이 불가능합니다.<br>
            동일한 이메일이나 휴대폰 번호로는 30일 동안 재가입 및 등록할 수 없습니다.
        </p>
      </div>
      <!--체크박스 -->
      <div class="flex">
        <label><input type="checkbox" v-model="checked" class="ml-[180px] mt-[20px]"></label>
        <p class="text-kb-gray-2 text-lg mt-[12px] px-2">해당 내용을 모두 확인했으며, 회원 탈퇴에 동의합니다.</p>    
    </div>
