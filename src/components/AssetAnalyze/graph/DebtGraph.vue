<template>
  <div v-if="isDebtDataReady" class="flex justify-center items-end h-[200px] mt-8 relative space-x-10">
    <!-- 내 자산 대비 부채율 그래프 -->
...
const maxDebtRatio = computed(() => Math.max(props.assetDebtRatio, props.averageDebtRatio));
